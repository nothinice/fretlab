...
assert.ok(html.includes("{key:'scaleShape', label:'Формы гаммы'}"),'Curated scale-form mode must be visible in the UI');
...
console.log(`OK: ${totalComplete} curated scale form/root realizations and 10 scale/chord relationships validated`);
